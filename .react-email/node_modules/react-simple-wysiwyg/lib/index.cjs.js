...
function Editor(_a) {
    ...
    if (editorState.htmlMode) {
        return (React__namespace.createElement("div", __assign({ className: "rsw-editor" }, containerProps),
            children,
...
var BtnStrikeThrough = createButton('Strike through', React__namespace.createElement("s", null, "ab"), 'strikeThrough');
...
function createDropdown(title, items) {
    ...
    function DropdownFactory(props) {
        ...
        return (React__namespace.createElement(Dropdown, __assign({}, props, { onChange: onChange, title: title, items: items, selected: activeIndex })));
        function onChange(e) {
            var target = e.target;
    ...
    return (React__namespace.createElement(EditorProvider, null,
        React__namespace.createElement(Editor, __assign({}, props),
            React__namespace.createElement(Toolbar, null,
                ...
                React__namespace.createElement(BtnStrikeThrough, null),
                React__namespace.createElement(Separator, null),
